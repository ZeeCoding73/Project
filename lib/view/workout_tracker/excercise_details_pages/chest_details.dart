...
class chestExercisesStepDetails extends StatefulWidget {

  const chestExercisesStepDetails({Key? key,}) : super (key: key);

  @override
  State<chestExercisesStepDetails> createState() => _ExercisesStepDetailsState();
}

class _ExercisesStepDetailsState extends State<chestExercisesStepDetails> {
  List stepArr = [
    {
      "no": "01",
